...
/**
 * @Author: sink
 * @Date:   2020-07-04 18:42:26
 * @Last Modified by:   sink <21901734@qq.com>
 * @Last Modified time: 2020-07-05 21:33:01
 */
...
class InotifyReload
{
    ...
    {
        LogEcho("SYS", "非inotify模式，性能极低，不建议在正式环境启用。请安装inotify扩展");
        if (isDarwin()) {
            LogEcho("SYS", "mac开启auto_reload可能会导致cpu占用过高。");
        }
